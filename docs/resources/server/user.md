...
| 39* | friendRequests      | **Integer** | The number of new friend requests you have (only returned when logged in and viewing own profile)                                                                                                           |
| 40* | newFriends          | **Integer** | The number of new friends the player has                                                                                                                                                                    |
...
- The `2` that Key `15` returns would have corresponded to the rainbow trail pre-2.0
