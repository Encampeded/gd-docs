...
Each `key` is tied to a component within the client and the `value` sets data for the specific component. A list of all known keys can be found in the table below. Keys indicated with an asterisk (*) are only returned from the getGJUserInfo20 endpoint.
...
| 6   | ranking             | **Integer** | The player's global leaderboard position                                                                                                                                                                    |
| 7   | accountHighlight    | **Integer** | The player's Account ID. Is used for highlighting the player on the leaderboards                                                                                                                            |
...
| 14  | iconType            | **Integer** | The icon displayed on leaderboards, comments, etc. See [Gamemode Enumeration](https://boomlings.dev/resources/client/level-components/enumerations#gamemode)                                                |
| 15  | special             | **Integer** | The player's special number                                                                                                                                                                                 |
| 16  | accountID           | **Integer** | The player's Account ID                                                                                                                                                                                     |
| 17  | userCoins           | **Integer** | The number of user coins the player has                                                                                                                                                                     |
| 18* | messageState        | **Integer** | Who can send the player messages. 0 = All, 1 = Only friends, 2 = None                                                                                                                                       |
| 19* | friendsState        | **Integer** | Who can send the player friend requests. 0 = All, 1 = None                                                                                                                                                  |
| 20* | youTube             | **String**  | The player's YouTube URL                                                                                                                                                                                    |
...
| 27  | accStreak           | **Integer** | The ID of the player's streak. Is not sent, see [trivia](#trivia)                                                                                                                                           |
| 28* | accGlow             | **Integer** | The ID of the player's glow                                                                                                                                                                                 |
| 29* | isRegistered        | **Bool**    | If the player is registered                                                                                                                                                                                 |
| 30* | globalRank          | **Integer** | The global rank of the player                                                                                                                                                                               |
| 31* | friendState         | **Integer** | 0 = Unfriended, 1 = Friended, 3 = Friend request sent to the player, 4 = Friend request received from the player                                                                                            |
| 38  | messages            | **Integer** | The number of new messages the player has (shown as a notification in-game)                                                                                                                                 | <!-- there are a bunch of keys before here but they are exclusive to friend requests so i didnt add them here -->
| 39  | friendRequests      | **Integer** | The number of new friend requests the player has (shown in-game as a notification)                                                                                                                          |
| 40  | newFriends          | **Integer** | The number of new Friends the player has (shown in-game as a notification)                                                                                                                                  |
...
| 44* | twitter             | **String**  | The Twitter URL of the player                                                                                                                                                                               |
| 45* | twitch              | **String**  | The Twitch URL of the player                                                                                                                                                                                |
| 46  | diamonds            | **Integer** | The number of diamonds the player have                                                                                                                                                                      |
| 48* | accExplosion        | **Integer** | The ID of the player's explosion effect                                                                                                                                                                     |
| 49* | modLevel            | **Integer** | The mod level of the player. 0 = None, 1 = Normal Mod (Yellow), 2 = Elder Mod (Orange)                                                                                                                      |
